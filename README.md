# Node.js Task-6 (Docker)

## Критерії прийому

- Створено репозиторій з домашнім завданням — Docker.
...
Створи гілку `06.1-docker` з гілки main.
...
Написати код для створення образу проекту (Docker). І додати файл в кореневу папку.
